...
public class RaceCar {
	...
	private SimpleDoubleProperty cornerWeightRR; // rear right corner weight in kg.
	private TireModel frontAxleTireModel; // front axle tire model of the car.
	private TireModel rearAxleTireModel; // rear axle tire model of the car.
