...
public class MagicFormulaTireModel implements TireModel {
	...
	private SimpleStringProperty name = new SimpleStringProperty(DEFAULT_NAME); // name of the tire.
	private SimpleDoubleProperty slipAngleCoefficientC; // coefficient C for the normalised slip-angle curve.
	private SimpleDoubleProperty slipAngleCoefficientB; // coefficient B for the normalised slip-angle curve.
	private SimpleDoubleProperty slipAngleCoefficientE; // coefficient E for the normalised slip-angle curve.
	private SimpleDoubleProperty loadCoefficientKA; // coefficient KA for the load function.
	private SimpleDoubleProperty loadCoefficientKB; // coefficient KB for the load function.
	 ...
	 */
	public MagicFormulaTireModel(Double slipAngleCoefficientC, Double slipAngleCoefficientB, Double slipAngleCoefficientE, Double loadCoefficientKA, Double loadCoefficientKB) {
